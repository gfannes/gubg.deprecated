...
(load (concat (getenv "EMACSRC") "/emacs-ruby/ruby-mode.el"))
(load (concat (getenv "EMACSRC") "/emacs-ruby/ruby-electric.el"))
(load (concat (getenv "EMACSRC") "/emacs-ruby/pabbrev.el"))
...
;puts
(global-set-key "\M-rp" 'ruby-insert-puts)
...
(defun ruby-insert-puts()
  (interactive)
  (ruby-insert-dot)
  (ruby-write-to-buffer "puts(\"\")")
  (backward-char 2)
  (indent-according-to-mode)
  )
...
(defun ruby-write-to-buffer (par)
  ""
