...
(global-set-key "\M-re" 'd-foreach-loop)
...
(defun d-foreach-loop(variableName arrayName)
  (interactive "MVariable: \nMArray: ")
  (d-write-to-buffer "foreach (")
  (d-write-to-buffer variableName)
  (d-write-to-buffer "; ")
  (d-write-to-buffer arrayName)
  (d-write-to-buffer ")")
  (indent-according-to-mode)
  (d-write-to-buffer "\n{")
  (indent-according-to-mode)
